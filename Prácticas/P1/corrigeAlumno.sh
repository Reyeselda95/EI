...
#                    CONTENDRA UN FICHERO makefile QUE GENERE EL EJECUTABLE $EJE CUYO PROGRAMA PRINCIPAL SERA $MAIN
...
# Fichero que contiene el main en el makefile (el que se haya puesto en src/ficheroMain.cpp en el makefile)
MAIN=main.cpp
# Nombre del ejecutable en el makefile (el que se haya puesto despues de -o en el makefile)
EJE=ejecutable
#################################################
