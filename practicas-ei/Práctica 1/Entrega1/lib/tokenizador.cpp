...
bool Tokenizador::Tokenizar (const string& i, const string& f) const{
	Tokenizador aux = Tokenizador(*this);
	ifstream file;
	ofstream ofile;
	string linea;
	list<string> tokens;
...
void Tokenizador::URL(string::size_type& pos, string::size_type& lastPos,const string& aux, const string& delimitadores,list<string>& tokens) const{
...
void Tokenizador::Numeros(string::size_type& pos, string::size_type& lastPos,string::size_type& posAcron,const string& aux, const string& delimitadores, list<string>& tokens)const{
	string delimaux=delimitadores;
	bool isNumber=true;
	bool decimal=false;
...
void Tokenizador::Email(string::size_type& pos, string::size_type& lastPos,const string& aux, const string& delimitadores, list<string>& tokens)const{
	string delimaux=delimitadores;
	string sinDelimURL; //Array sin delimitadores de URL
...
void Tokenizador::Acronimos(string::size_type& pos, string::size_type& lastPos,string::size_type& posAcron,const string& aux, const string& delimitadores, list<string>& tokens)const{
	string delimaux=delimitadores;
...
void Tokenizador::Guiones(string::size_type& pos, string::size_type& lastPos,const string& aux, const string& delimitadores, list<string>& tokens)const{
	string delimaux=delimitadores;
