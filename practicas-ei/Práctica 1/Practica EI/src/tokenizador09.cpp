...
// La lista de tokens a devolver debería contener: "pal1	10.00	10.000	000	aaa@10/12/85"
	imprimirListaSTL(tokens);
...
// La lista de tokens a devolver debería contener: "pal1	10.00	10.000	000	aaa@10/12/85	la"
	imprimirListaSTL(tokens);
