...
class Tokenizador {
	...
	public:
		...
		bool TokenizarDoc (const string& i, list<string>& tokens) const;
		// Tokeniza el fichero i guardando la salida en el fichero f (una palabra en cada línea del fichero). El fichero debe pasarse abierto.
		...
		bool URL(string::size_type& pos, string::size_type& lastPos,const string& aux, const string& delimitadores, list<string>& tokens)const;
		//realiza el caso de la URL
		bool Numeros(string::size_type& pos, string::size_type& lastPos,string::size_type& posAcron,const string& aux, const string& delimitadores, list<string>& tokens)const;
		//realiza el caso de los Numeros
		bool Email(string::size_type& pos, string::size_type& lastPos,const string& aux, const string& delimitadores, list<string>& tokens)const;
		//realiza el caso del Email
		bool Acronimos(string::size_type& pos, string::size_type& lastPos,string::size_type& posAcron,const string& aux, const string& delimitadores, list<string>& tokens)const;
		//realiza el caso de los Acronimos
		bool Guiones(string::size_type& pos, string::size_type& lastPos,const string& aux, const string& delimitadores, list<string>& tokens)const;
		//realiza el caso de la URL
	private:
		string delimiters;
